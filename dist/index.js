...
function usePhoneInput(options) {
  ...
  const previousValueRef = React.useRef(state.inputValue);
  const isInternalChangeRef = React.useRef(false);
  const prevControlledValueRef = React.useRef(controlledValue);
  React.useEffect(() => {
  ...
  const getPhoneValue = React.useCallback(() => {
...
var CountryFlag = React__default.default.memo(({ iso2, useSVG = true, flagUrl, size = 20 }) => {
  const [error, setError] = React__default.default.useState(false);
  if (error) {
    return /* @__PURE__ */ jsxRuntime.jsx("span", { className: CountryPhoneInput_default.flagEmoji, style: { fontSize: size }, children: getFlagEmoji(iso2) });
  }
  return (
...
var CountryOption = React__default.default.memo(({ country, useSVG, flagUrl }) => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: CountryPhoneInput_default.countryOption, children: [
    /* @__PURE__ */ jsxRuntime.jsx(CountryFlag, { iso2: country.iso2, useSVG, flagUrl }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: CountryPhoneInput_default.countryName, children: country.name }),
    /* @__PURE__ */ jsxRuntime.jsxs("span", { className: CountryPhoneInput_default.dialCode, children: [
      "+",
      country.dialCode
    ] })
  ] });
...
var SelectedCountry = React__default.default.memo(({ country, useSVG, flagUrl }) => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: CountryPhoneInput_default.selectedCountry, children: /* @__PURE__ */ jsxRuntime.jsx(CountryFlag, { iso2: country.iso2, useSVG, flagUrl, size: 18 }) });
});
SelectedCountry.displayName = "SelectedCountry";
var CountryPhoneInput = React.forwardRef(
  (props, ref) => {
    const {
      // Value props
      value,
    ...
    const antdInputRef = React.useRef(null);
    ...
    const selectOptions = React.useMemo(() => {
      return displayedCountries.map((country) => ({
        value: country.iso2,
        label: /* @__PURE__ */ jsxRuntime.jsx(CountryOption, { country, useSVG, flagUrl })
      }));
    ...
    const customDropdownRender = React.useCallback(
      (menu) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        enableSearch && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { padding: "8px" }, children: /* @__PURE__ */ jsxRuntime.jsx(
          antd.Input,
          {
            placeholder: searchPlaceholder,
            value: searchQuery,
            onChange: (e) => setSearchQuery(e.target.value),
            prefix: searchIcon || /* @__PURE__ */ jsxRuntime.jsxs(
              "svg",
              {
                width: "14",
                height: "14",
        ...
        displayedCountries.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { style: { padding: "8px 12px", color: "#999", textAlign: "center" }, children: searchNotFound }) : menu
      ] }),
    ...
    const suffixIcon = React.useMemo(() => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(icons.DownOutlined, { className: CountryPhoneInput_default.arrowIcon });
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: wrapperClassName, style, children: /* @__PURE__ */ jsxRuntime.jsxs(antd.Space.Compact, { block: true, className: grouped ? CountryPhoneInput_default.inputGroup : void 0, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        antd.Select,
        __spreadProps(__spreadValues({}, selectProps), {
          ...
          open,
          onOpenChange,
          labelRender: () => /* @__PURE__ */ jsxRuntime.jsx(
            SelectedCountry,
            {
...
exports.CountryPhoneInput = CountryPhoneInput_default2;
exports.DEFAULT_FLAG_CDN = DEFAULT_FLAG_CDN;
exports.buildInputValue = buildInputValue;
exports.buildPhoneValue = buildPhoneValue;
exports.countries = countries;
exports.default = CountryPhoneInput_default2;
exports.defaultCountry = defaultCountry;
exports.extractPhoneDigits = extractPhoneDigits;
exports.formatDialCode = formatDialCode;
exports.getBestCountryForDialCode = getBestCountryForDialCode;
exports.getCountriesByDialCode = getCountriesByDialCode;
exports.getCountryByIso2 = getCountryByIso2;
exports.getEffectiveMaxPhoneLength = getEffectiveMaxPhoneLength;
exports.getFilteredCountries = getFilteredCountries;
exports.getFlagEmoji = getFlagEmoji;
exports.getFlagUrl = getFlagUrl;
exports.getMaxPhoneLength = getMaxPhoneLength;
exports.getProtectedPrefixLength = getProtectedPrefixLength;
exports.guessCountryFromPhone = guessCountryFromPhone;
exports.resolveInitialCountry = resolveInitialCountry;
exports.searchCountries = searchCountries2;
exports.searchCountriesData = searchCountries;
